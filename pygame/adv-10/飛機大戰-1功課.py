...
#===載入圖片開始===
'''載入背景圖片'''
img_bg = pygame.image.load("image/space1.png")
'''載入飛船圖片'''
img_sship = [
    pygame.image.load("image/spaceship-m.png"),
    pygame.image.load("image/spaceship-m.png"),
    pygame.image.load("image/spaceship-m.png"),
]
'''載入飛船火焰'''
img_burn = pygame.image.load("image/starship_burner.png")
img_weapon = pygame.image.load("image/bullet1.png")
img_enemy = pygame.image.load("image/enemy.png")
#***載入圖片結束***
#===遊戲視窗設定開始===
bg_x = img_bg.get_width()
bg_y = img_bg.get_height()-300
bg_size = (bg_x, bg_y)
